-- =========================================================================
-- SkipFee · Bundle 0058  ·  decisiones de la prueba gratis
-- =========================================================================
-- Aplicar DESPUÉS de migrate_0055_to_0057.sql.
--
--   psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrate_0058.sql
--   (o pegarlo completo en el SQL Editor de Supabase)
--
-- Baja la prueba a 7 días, arranca el reloj desde el alta para las empresas que
-- todavía no lo tenían, y deja anotado que el vencimiento cierra el PANEL y no
-- la venta (ese corte lo aplica el backend, no la BD).
--
-- Reaplicable.
-- =========================================================================
